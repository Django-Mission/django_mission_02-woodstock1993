# Generated by Django 4.0.4 on 2022-04-22 06:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_phone', models.BooleanField(default=False, verbose_name='문자 메세지 수신 여부')),
                ...
                ('created_by', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='inquiry_created_by', to=settings.AUTH_USER_MODEL)),
                ('updated_by', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='inquiry_updated_by', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Answer',
